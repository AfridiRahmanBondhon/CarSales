...
INSERT INTO Admin_info VALUES ('Shizan',117,1001,4)
...
INSERT INTO Seller_info VALUES ('Afridi',128,01521585858,'180204128@aust.edu',1122334455,1003)
--INSERT INTO Seller_info VALUES ('Shizan',117,01521669423,'180204117@aust.edu',1122334456,1004)

--INSERT INTO Seller_info VALUES ('Nuru',130)

select * from Seller_info
--delete from Seller_info where Seller_id = 2
...
INSERT INTO Car_info VALUES ('Audi A2','Black','Audi','sedan','786',9999900,8525500,'sold')
...
SELECT s.Name, s.Number, s.email, s.Product_id, c.Name, c.Product_id,  c.Brand, c.Model, c.sell_status
FROM Car_info c right outer JOIN Seller_info s
ON c.Product_id = s.Product_id where c.product_id = '1001'
